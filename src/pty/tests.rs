...
use crate::pty::combine_output_receivers;
#[cfg(unix)]
use crate::pty::pipe::spawn_process_no_stdin_with_inherited_fds;
#[cfg(unix)]
use crate::pty::pty::spawn_process_with_inherited_fds;
use crate::pty::spawn_from_driver;
use crate::pty::spawn_pipe_process;
use crate::pty::spawn_pipe_process_no_stdin;
...
async fn pty_spawn_with_inherited_fds_reports_exec_failures() -> anyhow::Result<()> {
    ...
    let err: anyhow::Error = match spawn_result {
        Ok(spawned) => {
