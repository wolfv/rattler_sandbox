...
use crate::pty::process::ChildTerminator;
use crate::pty::process::ProcessHandle;
use crate::pty::process::PtyHandles;
use crate::pty::process::PtyMasterHandle;
use crate::pty::process::SpawnedProcess;
use crate::pty::process::TerminalSize;

/// Returns true when ConPTY support is available (Windows only).
#[cfg(windows)]
pub fn conpty_supported() -> bool {
    crate::pty::win::conpty_supported()
}
    ...
    fn kill(&mut self) -> std::io::Result<()> {
        ...
        if let Some(process_group_id) = self.process_group_id {
            ...
            let process_group_kill_result =
                crate::pty::process_group::kill_process_group(process_group_id);
...
fn platform_native_pty_system() -> Box<dyn portable_pty::PtySystem + Send> {
    #[cfg(windows)]
    {
        Box::new(crate::pty::win::ConPtySystem::default())
    }
