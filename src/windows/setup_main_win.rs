...
// `firewall` / `read_acl_mutex` / `sandbox_users` / `setup_runtime_bin` are
// declared at `crate::windows::mod`. The codex layout had them as siblings of
// this file and re-declared them here.
use crate::windows::firewall;

use anyhow::Context;
use anyhow::Result;
use base64::Engine;
use base64::engine::general_purpose::STANDARD as BASE64;
use crate::windows::otel_stub::StatsigMetricsSettings;
use crate::windows::LOG_FILE_NAME;
use crate::windows::SETUP_VERSION;
use crate::windows::SetupErrorCode;
use crate::windows::SetupErrorReport;
use crate::windows::SetupFailure;
use crate::windows::add_deny_write_ace;
use crate::windows::canonicalize_path;
use crate::windows::convert_string_sid_to_sid;
use crate::windows::ensure_allow_mask_aces_with_inheritance;
use crate::windows::ensure_allow_write_aces;
use crate::windows::extract_setup_failure;
use crate::windows::hide_newly_created_users;
use crate::windows::install_wfp_filters;
use crate::windows::is_command_cwd_root;
use crate::windows::load_or_create_cap_sids;
use crate::windows::log_note;
use crate::windows::path_mask_allows;
use crate::windows::sandbox_bin_dir;
use crate::windows::sandbox_dir;
use crate::windows::sandbox_secrets_dir;
use crate::windows::string_from_sid_bytes;
use crate::windows::to_wide;
use crate::windows::workspace_cap_sid_for_cwd;
use crate::windows::write_setup_error_report;
...
use crate::windows::read_acl_mutex::acquire_read_acl_mutex;
use crate::windows::read_acl_mutex::read_acl_mutex_exists;
use crate::windows::sandbox_users::provision_sandbox_users;
use crate::windows::sandbox_users::resolve_sandbox_users_group_sid;
use crate::windows::sandbox_users::resolve_sid;
use crate::windows::sandbox_users::sid_bytes_to_psid;
use crate::windows::setup_runtime_bin;
...
pub(crate) fn log_line(log: &mut File, msg: &str) -> Result<()> {
