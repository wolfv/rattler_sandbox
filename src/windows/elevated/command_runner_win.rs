...
use crate::windows::LocalSid;
use crate::windows::Message;
use crate::windows::OutputPayload;
...
use crate::windows::StdinMode;
use crate::windows::allow_null_device;
use crate::windows::create_readonly_token_with_caps_and_user_from;
use crate::windows::create_workspace_write_token_with_caps_and_user_from;
use crate::windows::decode_bytes;
use crate::windows::encode_bytes;
use crate::windows::get_current_token_for_restriction;
use crate::windows::hide_current_user_profile_dir;
use crate::windows::log_note;
use crate::windows::parse_policy;
use crate::windows::read_frame;
use crate::windows::read_handle_loop;
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<crate::windows::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    let (pi, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = crate::windows::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
