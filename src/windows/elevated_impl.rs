...
mod windows_impl {
    ...
    use crate::windows::elevated::ipc_framed::OutputStream;
    ...
    use crate::windows::elevated::runner_client::spawn_runner_transport;
    ...
    pub use crate::windows::CaptureResult;
        ...
        let (psid_to_use, cap_sids) = match &policy {
            ...
            SandboxPolicy::WorkspaceWrite { .. } => {
                ...
                (
                    ...
                    vec![
                        caps.workspace,
                        crate::windows::cap::workspace_cap_sid_for_cwd(codex_home, cwd)?,
                    ],
                )
            }
            SandboxPolicy::DangerFullAccess | SandboxPolicy::ExternalSandbox { .. } => {
